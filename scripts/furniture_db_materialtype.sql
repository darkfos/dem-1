...
CREATE TABLE `materialtype` (
  ...
  `name_material` varchar(200) DEFAULT NULL,
  `procent` varchar(8) DEFAULT NULL,
...
INSERT INTO `materialtype` VALUES (1,'Дерево','0.0055'),(2,'Древесная плита','0.003'),(3,'Текстиль','0.0015'),(4,'Стекло','0.0045'),(5,'Металл','0.001'),(6,'Пластик','0.0005');
